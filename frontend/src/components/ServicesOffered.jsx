...
const servicesData = {
  Massage: [
    {
      ...
      description: `Designed to address muscle tension and pain with targeted techniques tailored to your unique needs...`,
      fullDescription: `A 60 minute Remedial Massage, designed to target specific muscle groups and alleviate discomfort caused by stress, tension, or injury. This form of massage uses a combination of deep tissue techniques, trigger point therapy, and stretching to address musculoskeletal issues, improve circulation, and promote overall well-being. Whether you’re managing chronic pain, or seeking relief from everyday tension, Remedial Massage offers personalized treatments tailored to your needs. The massage therapist applies focused pressure to problem areas, breaking down muscle knots, reducing inflammation, and restoring mobility. Remedial massage is particularly effective for conditions such as lower back pain, neck and shoulder tension, headaches, and sports-related injuries. Feel the stress melt away as your body is nurtured, realigned, and rejuvenated. Book your Remedial Massage session today for a customized treatment that supports your body’s natural healing process.`,
      price: "A$99.00",
      duration: "1 hr",
      isIntroductory: true,
      image: remedialImg,
    },
    {
      ...
      description: `Experience the bliss of total relaxation with a massage designed to melt away tension and calm your mind...`,
      fullDescription: `Indulge in the ultimate relaxation experience with our 60 minute Relaxation Massage, combining the soothing benefits of coconut oil, magnesium, and lemongrass. This luxurious treatment begins with the nourishing properties of coconut oil, which deeply moisturizes and softens the skin. The addition of magnesium promotes muscle relaxation, eases tension, and supports your body’s natural healing process, while lemongrass provides an invigorating, fresh scent that helps clear your mind and refresh your spirit. Lesley expertly applies gentle massage techniques to melt away stress, reduce muscle tightness, and restore balance to your body and mind. Whether you're seeking relief from physical tension or a peaceful escape from everyday stress, this massage is the perfect way to unwind and rejuvenate. Book your Relaxation Massage today for a calming, healing experience that nurtures your body, mind, and soul.`,
      price: "A$99.00",
    ...
    },
    {
      ...
      description: `Trigger point massages are best suited for people who have injuries, chronic pain, or a specific issue or condition...`,
      fullDescription: `Experience targeted relief with our 60-minute full body Trigger Point Massage. This specialized treatment focuses on releasing tight, painful knots—known as trigger points—that can cause discomfort and radiating pain throughout the body. Using deep, focused pressure and precise techniques, your therapist will work to identify and alleviate tension in key muscle groups, restoring mobility and easing chronic pain. This session is ideal for those with repetitive strain injuries, muscle overuse, or postural imbalances. By the end of your session, you’ll feel lighter, more flexible, and deeply relaxed—ready to move through your day with renewed comfort and ease.`,
      price: "A$99.00",
      // originalPrice: "A$99.00",
      duration: "1 hr",
      isIntroductory: true,
  ...
  Healing: [
    ...
    },
    {
      ...
      description: `Heal the roots to free the soul. This deeply transformative session connects you to the energetic threads of your lineage...`,
      fullDescription: `Heal the roots to free the soul. This deeply transformative 60-minute session connects you to the energetic threads of your lineage, gently clearing inherited patterns, emotional wounds, and ancestral imprints that may be affecting your present life. Through guided energy work, intuitive insight, and spiritual connection, we release burdens carried across generations — restoring balance, reclaiming power, and inviting peace for both you and your bloodline. Ideal for: Repeating life patterns, family trauma, unexplained emotions, feeling blocked or disconnected.`,
      price: "A$130.00",
      duration: "1 hr",
